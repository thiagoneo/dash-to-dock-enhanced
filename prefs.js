...
const DockSettings = GObject.registerClass({
    ...
    _init(extensionPreferences) {
        ...
        this._settings = extensionPreferences.getSettings(
            'org.gnome.shell.extensions.dash-to-dock-enhanced');
    ...
    _bindSettings() {
        ...
        this._settings.bind('show-windows-preview',
            ...
            'active',
            Gio.SettingsBindFlags.DEFAULT);
        // ── Hover window preview settings ─────────────────────────────────────
        this._settings.bind('hover-window-preview',
            this._builder.get_object('hover_window_preview_switch'),
            'active',
            Gio.SettingsBindFlags.DEFAULT);
        this._settings.bind('hover-preview-delay',
            this._builder.get_object('hover_preview_delay_spin'),
            'value',
            Gio.SettingsBindFlags.DEFAULT);
        this._settings.bind('max-preview-side-by-side',
            this._builder.get_object('max_preview_side_by_side_spin'),
            'value',
            Gio.SettingsBindFlags.DEFAULT);
        this._settings.bind('multi-monitor',
